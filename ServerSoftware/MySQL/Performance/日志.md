...
* `slow_query_log`
  ...
  <img src="../Images/Performance/slow_query_log参数.png" style="zoom: 50%;" />
...
* `long_query_time` 
  ...
  <img src="../Images/Performance/long_query_time参数.png" style="zoom:50%;" />
...
* `log_queries_not_using_indexes`
  ...
  <img src="../Images/Performance/log_queries_not_using_indexes参数.png" style="zoom:50%;" />
